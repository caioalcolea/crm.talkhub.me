...
class MockData {
  ...
  static final List<User> users = [
    User(
      id: 'user-1',
      name: 'Alex Johnson',
      email: 'alex.johnson@crmtalkhub.com',
    ...
    User(
      id: 'user-2',
      name: 'Sarah Williams',
      email: 'sarah.williams@crmtalkhub.com',
    ...
    User(
      id: 'user-3',
      name: 'Michael Chen',
      email: 'michael.chen@crmtalkhub.com',
    ...
    User(
      id: 'user-4',
      name: 'Emily Davis',
      email: 'emily.davis@crmtalkhub.com',
