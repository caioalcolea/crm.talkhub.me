...
urlpatterns = [
    ...
    path("auth/accept-invite/", InvitationAcceptAPIView.as_view(), name="accept_invite"),
    ...
    path("invitations/<str:pk>/", InvitationCancelView.as_view()),
    path("invitations/<str:pk>/resend/", InvitationResendView.as_view()),
]
