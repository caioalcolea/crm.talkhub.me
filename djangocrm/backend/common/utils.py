...
CONTACT_SOURCE = (
    ("manual", "Manual"),
    ("import", "Importação"),
    ("talkhub_whatsapp", "TalkHub - WhatsApp"),
    ("talkhub_facebook", "TalkHub - Facebook"),
    ("talkhub_instagram", "TalkHub - Instagram"),
    ("talkhub_messenger", "TalkHub - Messenger"),
    ("talkhub_telegram", "TalkHub - Telegram"),
    ("talkhub_sms", "TalkHub - SMS"),
    ("talkhub_email", "TalkHub - Email"),
    ("talkhub_webchat", "TalkHub - WebChat"),
    ("talkhub_other", "TalkHub - Outro"),
    ("email", "Email"),
    ("call", "Call"),
    ("api", "API"),
    ("other", "Outro"),
...
CURRENCY_CODES = (
    ...
    ("ETH", _("ETH, Ethereum")),
    ("USDT", _("USDT, Tether")),
    ("USDC", _("USDC, USD Coin")),
    ("SOL", _("SOL, Solana")),
    ("BNB", _("BNB, Binance Coin")),
    ("XRP", _("XRP, Ripple")),
    ("ADA", _("ADA, Cardano")),
)
