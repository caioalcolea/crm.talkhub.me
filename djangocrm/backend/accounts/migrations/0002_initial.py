...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='account',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='account_tags', to='common.tags'),
        ),
        migrations.AddField(
            model_name='account',
            name='teams',
        ...
        migrations.AddConstraint(
            model_name='account',
            constraint=models.UniqueConstraint(django.db.models.functions.text.Lower('name'), models.F('org'), name='unique_account_name_per_org'),
        ),
        migrations.AddConstraint(
            model_name='account',
            constraint=models.CheckConstraint(condition=models.Q(('annual_revenue__gte', 0), ('annual_revenue__isnull', True), _connector='OR'), name='account_revenue_non_negative'),
        ),
        migrations.AddIndex(
            model_name='accountemail',
