...
class LeadListView(APIView, LimitOffsetPagination):
    ...
    def get_context_data(self, **kwargs):
        ...
        queryset = (
            ...
            .select_related("created_by", "stage", "stage__pipeline")
            .prefetch_related(
                "tags",
                "assigned_to",
                "contacts",
    ...
    def post(self, request, *args, **kwargs):
        ...
        # Contact-First: novos leads devem ter pelo menos um contato vinculado
            ...
            return Response(
                {
                    ...
                    "errors": {
                        "contacts": [
                            "É necessário vincular pelo menos um contato ao lead."
                        ]
                    },
                },
