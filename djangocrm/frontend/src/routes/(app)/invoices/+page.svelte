<script>
  ...
  const STATUS_CHIPS = [
    ...
    { key: 'PAID', label: 'Pago', statuses: ['Paid', 'Partially_Paid'] },
    { key: 'OVERDUE', label: 'Vencido', statuses: ['Overdue'] },
...
<svelte:head>
  <title>Faturas | TalkHub CRM</title>
</svelte:head>
  ...
  <CrmTable data={invoices} {columns} bind:visibleColumns onRowClick={handleRowClick}>
    {#snippet emptyState()}
      <div class="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h3 class="text-lg font-medium text-[var(--text-primary)]">Nenhuma fatura ainda</h3>
