...
export async function load({ locals, cookies, url }) {
  ...
  try {
    ...
    throw error(500, 'Falha ao carregar objetivos');
  }
}
...
export const actions = {
  create: async ({ request, locals, cookies }) => {
    try {
      ...
      return { success: true, message: 'Objetivo criado com sucesso' };
    } catch (err) {
  ...
  update: async ({ request, locals, cookies }) => {
    try {
      ...
      return { success: true, message: 'Objetivo atualizado com sucesso' };
    } catch (err) {
  ...
  delete: async ({ request, locals, cookies }) => {
    try {
      ...
      return { success: true, message: 'Objetivo excluído com sucesso' };
    } catch (err) {
