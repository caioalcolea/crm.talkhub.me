  ...
  function handleMagicLink() {
    ...
    return async ({ result }) => {
      ...
      if (result.type === 'success') {
        ...
        magicLinkError = result.data?.error || 'Algo deu errado. Por favor, tente novamente.';
      }
    };
  }
</script>
...
<svelte:head>
  <title>Entrar | TalkHub CRM</title>
  <meta
    name="description"
    content="Entre ou cadastre-se no TalkHub CRM para gerenciar seus contatos, negócios e expandir sua empresa."
  />
</svelte:head>
...
<div class="login-page">
  ...
  <div class="login-wrapper">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-text">TalkHub CRM</span>
    </a>
    ...
    <div class="login-card">
      {#if data.hasInvite}
        <div class="invite-banner">
          <p>Você foi convidado para uma organização. Faça login ou cadastre-se para aceitar o convite.</p>
        </div>
      {/if}
      ...
      {#if magicLinkSent}
        <div class="magic-link-success">
          <p>Verifique seu e-mail para o link de acesso.</p>
          <p class="magic-link-hint">O link expira em 10 minutos.</p>
        </div>
      {:else}
    ...
    <div class="help-section">
      <p class="help-text">Novo por aqui? Basta digitar seu e-mail acima para começar.</p>
    </div>

    <!-- Footer -->
    <footer class="login-footer">
      <a href="https://crmtalkhub.com/privacy-policy">Política de Privacidade</a>
      <span class="dot"></span>
      <a href="https://crmtalkhub.com/terms">Termos de Serviço</a>
    </footer>
  </div>
</div>
