...
<div class="space-y-4">
  ...
  {#if comments.length === 0}
    ...
    >
      ...
      <p class="mt-3 text-sm font-medium text-gray-500 dark:text-gray-400">Nenhum comentário ainda</p>
      <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">Seja o primeiro a comentar</p>
    </div>
  {:else}
    <div class="space-y-1">
...
<AlertDialog.Root bind:open={deleteDialogOpen}>
  <AlertDialog.Content>
    <AlertDialog.Header>
      <AlertDialog.Title>Excluir comentário</AlertDialog.Title>
