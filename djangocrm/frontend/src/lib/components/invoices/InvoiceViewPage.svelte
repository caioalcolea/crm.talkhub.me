<script>
  ...
  function formatPaymentTerms(terms) {
    const termsMap = {
      DUE_ON_RECEIPT: 'Pagamento à vista',
      NET_15: 'Net 15',
      NET_30: 'Net 30',
      NET_45: 'Net 45',
      NET_60: 'Net 60',
  ...
  const companyDisplayName = $derived(company?.companyName || company?.name || 'Sua Empresa');
  ...
  <div class="invoice-container">
    ...
    <header class="header">
      <div class="company-details">
        ...
        {#if company?.website}
          <p>
            Site: <a href={company.website} target="_blank" rel="noopener noreferrer"
    ...
    <section class="info-section">
      <div class="client-address">
        <h3>{invoice.clientName || 'Nome do Cliente'}</h3>
    ...
    <table class="line-items-table">
      ...
      <tbody>
        ...
        {:else}
          <tr>
            <td colspan="4" class="no-items">Nenhum item</td>
          </tr>
        {/if}
      </tbody>
    </table>
    ...
    <div class="totals-container">
      <table class="totals-table">
        <tbody>
          ...
          <tr>
            <td class="totals-label">Frete</td>
            <td class="totals-value">
          ...
          {/if}
          <tr>
            <td class="totals-label">Imposto</td>
            <td class="totals-value">
    ...
    <div class="copyright">
      ...
      {/if}
      {#if company?.taxId}
        <p>CNPJ/CPF: {company.taxId}</p>
      {/if}
      <p>Copyright &copy; {new Date().getFullYear()}. {companyDisplayName}. Todos os direitos reservados.</p>
    </div>
  </div>
</div>
