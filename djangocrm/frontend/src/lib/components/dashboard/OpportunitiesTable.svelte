  ...
  <div class="flex-1 overflow-auto">
    {#if openOpportunities.length === 0}
      <div class="flex h-full flex-col items-center justify-center py-10 text-center">
        ...
        <p class="text-sm font-medium text-[var(--text-secondary)]">Nenhum negócio aberto</p>
        <p class="text-xs text-[var(--text-tertiary)]">Crie um para começar a acompanhar</p>
      </div>
    {:else}
