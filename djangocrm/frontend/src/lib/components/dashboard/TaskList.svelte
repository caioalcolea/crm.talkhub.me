...
>
  ...
  >
    <div class="flex items-center gap-3">
      ...
      <h3 class="text-sm font-semibold tracking-tight text-[var(--text-primary)]">Minhas Tarefas</h3>
    </div>
  ...
  <div class="flex-1 overflow-auto">
    {#if filteredTasks().length === 0}
      <div class="flex h-full flex-col items-center justify-center py-10 text-center">
        ...
        <p class="text-sm font-medium text-[var(--text-secondary)]">Nenhuma tarefa encontrada</p>
        <p class="text-xs text-[var(--text-tertiary)]">Tudo em dia!</p>
      </div>
    {:else}
