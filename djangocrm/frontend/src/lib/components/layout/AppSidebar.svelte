<script>
  ...
  /** @type {Props} */
  let { user = {}, org_name = 'TalkHub CRM' } = $props();
  ...
  const financeiroItems = [
    {
      ...
      type: 'dropdown',
      children: [
        { href: '/financeiro', label: 'Painel', icon: PieChart, preload: 'off' },
        { href: '/financeiro/lancamentos', label: 'Lançamentos', icon: Receipt, preload: 'off' },
        { href: '/financeiro/pagar', label: 'Contas a Pagar', icon: ArrowUpCircle, preload: 'off' },
        { href: '/financeiro/receber', label: 'Contas a Receber', icon: ArrowDownCircle, preload: 'off' },
        { href: '/financeiro/plano-de-contas', label: 'Centro de Custo', icon: BookOpen, preload: 'off' },
        { href: '/financeiro/formas-pagamento', label: 'Formas de Pgto', icon: CreditCard, preload: 'off' },
        { href: '/financeiro/pix', label: 'PIX', icon: QrCode, preload: 'off' },
        { href: '/financeiro/relatorios', label: 'Relatórios', icon: BarChart3, preload: 'off' }
      ]
    }
  ];
        ...
        <Sidebar.MenuButton size="lg" class="group relative hover:bg-transparent">
          {#snippet child({ props })}
            <a href="/" {...props} class="flex items-center gap-3">
              ...
              >
                <img src="/icon.svg" alt="Logo" class="size-8 group-data-[collapsible=icon]:size-6" />
              </div>
    ...
    <Sidebar.Menu class="space-y-1">
      ...
      <Sidebar.MenuItem>
        <Sidebar.MenuButton
          ...
          tooltipContent={sidebar.state === 'collapsed' ? 'Expandir menu' : 'Recolher menu'}
        ...
        <DropdownMenu.Root>
          ...
          >
            ...
            <DropdownMenu.Group class="flex gap-1 px-2 py-1.5">
              ...
              >
                <Sun class="size-4" />
                <span class="text-[10px] font-medium">Claro</span>
              </button>
              <button
              ...
              >
                <Moon class="size-4" />
                <span class="text-[10px] font-medium">Escuro</span>
              </button>
              <button
              ...
              >
                ...
                <span class="text-[10px] font-medium">Sistema</span>
              </button>
            </DropdownMenu.Group>
            <DropdownMenu.Separator />
            <DropdownMenu.Item
